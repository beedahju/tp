...
public class JsonAdaptedPersonTest {
    ...
    private static final String VALID_PAYMENT_DATE = "2026-01-13";
    private static final String VALID_LAST_ATTENDANCE = "2026-01-29T08:00:00";
    private static final String VALID_PARENT_NAME = BENSON.getGuardian().map(g -> g.getName()).map(n -> n.fullName)
            .orElse(null);
    private static final String VALID_PARENT_PHONE = BENSON.getGuardian().map(g -> g.getPhone()).map(p -> p.value)
            .orElse(null);
    private static final String VALID_PARENT_EMAIL = BENSON.getGuardian().map(g -> g.getEmail()).map(e -> e.value)
            .orElse(null);
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(INVALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                VALID_TAGS, VALID_SUBJECTS, VALID_PARENT_NAME, VALID_PARENT_PHONE, VALID_PARENT_EMAIL,
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(null, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_TAGS,
                VALID_SUBJECTS, VALID_PARENT_NAME, VALID_PARENT_PHONE, VALID_PARENT_EMAIL, VALID_APPOINTMENT_START,
                VALID_PAYMENT_DATE, VALID_LAST_ATTENDANCE);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                invalidTags, VALID_SUBJECTS, VALID_PARENT_NAME, VALID_PARENT_PHONE, VALID_PARENT_EMAIL,
                VALID_APPOINTMENT_START, VALID_PAYMENT_DATE, VALID_LAST_ATTENDANCE);
    ...
    public void toModelType_invalidAppointmentStart_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                VALID_TAGS, VALID_SUBJECTS, VALID_PARENT_NAME, VALID_PARENT_PHONE, VALID_PARENT_EMAIL,
                INVALID_APPOINTMENT_START, VALID_PAYMENT_DATE, VALID_LAST_ATTENDANCE);
        assertThrows(IllegalValueException.class, person::toModelType);
    }
    ...
    public void toModelType_invalidPaymentDate_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                VALID_TAGS, VALID_SUBJECTS, VALID_PARENT_NAME, VALID_PARENT_PHONE, VALID_PARENT_EMAIL,
                VALID_APPOINTMENT_START, INVALID_PAYMENT_DATE, VALID_LAST_ATTENDANCE);
        assertThrows(IllegalValueException.class, person::toModelType);
    }
    ...
    public void toModelType_invalidLastAttendance_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                VALID_TAGS, VALID_SUBJECTS, VALID_PARENT_NAME, VALID_PARENT_PHONE, VALID_PARENT_EMAIL,
                VALID_APPOINTMENT_START, VALID_PAYMENT_DATE, INVALID_LAST_ATTENDANCE);
        assertThrows(IllegalValueException.class, person::toModelType);
    }
    ...
    public void toModelType_invalidSubjects_throwsIllegalValueException() {
        ...
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                VALID_TAGS, invalidSubjects, VALID_PARENT_NAME, VALID_PARENT_PHONE, VALID_PARENT_EMAIL,
                VALID_APPOINTMENT_START, VALID_PAYMENT_DATE, VALID_LAST_ATTENDANCE);
    ...
    public void toModelType_invalidParentName_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                VALID_TAGS, VALID_SUBJECTS, INVALID_NAME, VALID_PARENT_PHONE, VALID_PARENT_EMAIL,
                VALID_APPOINTMENT_START, VALID_PAYMENT_DATE, VALID_LAST_ATTENDANCE);
        String expectedMessage = Name.MESSAGE_CONSTRAINTS;
        assertThrows(IllegalValueException.class, expectedMessage, person::toModelType);
    }
    ...
    public void toModelType_invalidParentPhone_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                VALID_TAGS, VALID_SUBJECTS, VALID_PARENT_NAME, INVALID_PHONE, VALID_PARENT_EMAIL,
                VALID_APPOINTMENT_START, VALID_PAYMENT_DATE, VALID_LAST_ATTENDANCE);
        String expectedMessage = Phone.MESSAGE_CONSTRAINTS;
        assertThrows(IllegalValueException.class, expectedMessage, person::toModelType);
    }
    ...
    public void toModelType_invalidParentEmail_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                VALID_TAGS, VALID_SUBJECTS, VALID_PARENT_NAME, VALID_PARENT_PHONE, INVALID_EMAIL,
                VALID_APPOINTMENT_START, VALID_PAYMENT_DATE, VALID_LAST_ATTENDANCE);
        String expectedMessage = Email.MESSAGE_CONSTRAINTS;
        assertThrows(IllegalValueException.class, expectedMessage, person::toModelType);
    }
    ...
    public void toModelType_emptySubjects_returnsPerson() throws Exception {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                VALID_TAGS, new ArrayList<>(), VALID_PARENT_NAME, VALID_PARENT_PHONE, VALID_PARENT_EMAIL,
                VALID_APPOINTMENT_START, VALID_PAYMENT_DATE, VALID_LAST_ATTENDANCE);
