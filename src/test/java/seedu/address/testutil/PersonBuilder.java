...
public class PersonBuilder {
    ...
    public Person build() {
        ...
        return new seedu.address.model.person.PersonBuilder(name, phone, email, address, tags).withAcademics(academics)
                .withGuardian(guardian).withAppointmentStart(appointmentStart).withBilling(billing)
                .withLastAttendance(lastAttendance).build();
    }
}
