...
public class EditParentCommand extends EditCommand {
    ...
    public boolean equals(Object other) {
        ...
        return index.equals(otherCommand.index) && editParentDescriptor.equals(otherCommand.editParentDescriptor);
    }

    @Override
    public String toString() {
        return new ToStringBuilder(this).add("index", index).add("editParentDescriptor", editParentDescriptor)
                .toString();
    }

    /**
     * Stores the details to edit the parent with. Each non-empty field value will replace the corresponding parent
    ...
    public static class EditParentDescriptor {
        ...
        public boolean equals(Object other) {
            ...
            return Objects.equals(parentName, e.parentName) && Objects.equals(parentPhone, e.parentPhone)
                    && Objects.equals(parentEmail, e.parentEmail);
        }

        @Override
        public String toString() {
            return new ToStringBuilder(this).add("parentName", parentName.orElse(null))
                    .add("parentPhone", parentPhone.orElse(null)).add("parentEmail", parentEmail.orElse(null))
                    .toString();
        }
    }
}
